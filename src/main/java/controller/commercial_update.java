...
public class commercial_update extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    Double area1 = null;
	    try {
	        area1 = Double.parseDouble(area1Param);
	    } catch (NumberFormatException e) {
	        // Handle the error - set a default value or send an error response
	        // You can also redirect to an error page or display an error message
	        area1 = 0.0; // or some default value
	        System.out.println("Invalid input for area: " + area1Param);
	        e.printStackTrace();
	    }
