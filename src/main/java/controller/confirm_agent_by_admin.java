...
@WebServlet("/confirm_agent_by_admin")
public class confirm_agent_by_admin extends HttpServlet {
	...
	String emailContent = "<html><body><table class=\"body-wrap\" style=\"font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;\" bgcolor=\"#f6f6f6\">\r\n"
	        ...
	        + "                                                    Dear " + f + ",<br><br>"
	        + "                                                    Congratulations! Your request to register as an agent with Fair Property has been successfully received. Once your application is reviewed and approved, we will notify you by email for further process.<br><br>"
