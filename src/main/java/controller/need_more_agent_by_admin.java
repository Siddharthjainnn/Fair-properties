...
@WebServlet("/need_more_agent_by_admin")
public class need_more_agent_by_admin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i!=0)
		{
			sendOrderConfirmationEmail(c, g, f);
		...
		private void sendOrderConfirmationEmail(String recipientEmail, String additionalInfo, String agentName) {
		    ...
		    try {
		        ...
		        message.setSubject("Additional Information Required for Your Agent Registration");
		        ...
		        String emailContent = "<html><body><table class=\"body-wrap\" style=\"font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;\" bgcolor=\"#f6f6f6\">\r\n"
		            ...
		            + "                                                    We have reviewed your agent registration request. However, we require some additional information to complete your application. Please provide the following information:<br><br>"
		            + "                                                    " + additionalInfo + "<br><br>"
		            + "                                                    Once we receive the required information, we will proceed with your application.<br><br>"
