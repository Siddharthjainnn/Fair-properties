    ...
    <div class="jumbotron jumbotron-fluid" style="padding-left:3cm;padding-right: 3cm; ">
        <div class="row justify-content-center text-center mb-4">
            <div class="col-xl-6 col-lg-8 col-sm-10">
                <h2 class="font-weight-bold">Discover Property Fair <br>Where Your Real Estate Goals Become Reality</h2>
                <p class="text-muted mb-0">Welcome to <b>Property Fair</b>, Where your estate aspirations are our top priority. Our Dedicate team of professionals combines market expertise, innovative technology and personalized service to guide you through every step of your property journey</p>
            </div>
        </div>
            ...
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Client-Centric Apporoch</h6>
                        <p class="text-muted mb-0">Putting your goals first with personalized solution tailored to your needs</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Marketing Knowledge</h6>
                        <p class="text-muted mb-0">Deep insights into local market trends and property value for informed decisions</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Strong Track Record</h6>
                        <p class="text-muted mb-0">Proven success with satisfied client and numerous testimonials to showcase</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Personalized Service</h6>
                        <p class="text-muted mb-0">Tailored recommendetions and dedicated service that puts you at the center</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Effective Communication</h6>
                        <p class="text-muted mb-0">Revolutionizing real estate with cutting-edge tools and digital solution</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Network and Resources</h6>
                        <p class="text-muted mb-0">Access to an extensive network for off-market listings and exclusive opportunities</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Transparent and Honest Approach</h6>
                        <p class="text-muted mb-0">Commitment to integrity, transparency, and ethical conduct in all dealings</p>
                    </div>
                </div>
            </div>
            <div class="col my-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Community Involvement</h6>
                        <p class="text-muted mb-0">Active in supporting local communities through philanthropic</p>
                    </div>
                </div>
            </div>
            <div class="col mb-0 mt-3 mb-lg-3">
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mb-3">Experience and Expertise</h6>
                        <p class="text-muted mb-0">5+ year in real estate with a track record of navigating diverse market cycles</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mt-4 pt-2">
                            <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                <img src="https://website-assets-fd.freshworks.com/attachments/ckv0smc5x01b5bgg0vnpf4vu4-banner1.one-half.png" class="img-fluid" alt="Image" />
                ...
                <div class="row">
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            ...
                            <h3 class="ml-3 mb-0">24*7 Support</h3>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-file-download h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Better Customer Interaction</h3>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Provide Tailored Solution</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Virtual Property Tours</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Gives the market Knowledge</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Personalized Consultations</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Legal Assistance</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Investment Advice</h3>
                        </div>
                    </div>
                     <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            <i class="fa fa-user h4 mb-0 text-custom"></i>
                            <h3 class="ml-3 mb-0">Customer Feedback</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4 pt-2">
                        <div class="media align-items-center rounded shadow p-3">
                            ...
                            <h3 class="ml-3 mb-0">Property Management Service</h3>
                        </div>
                    </div>
                </div>
            </div>
