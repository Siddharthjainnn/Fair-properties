...
<%agent ak=(agent)session.getAttribute("m"); %>
    ...
    String l=ak.getStatus();
    if (kk.equals("pasx87")&& l.equals("confirm") ) {
%>
...
<div class="container h-100">
    ...
    <%} else if (kk.equals("pasx87") && l.equals("Submitted")) { %>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="main-img text-center">
                        <img src="./image/under review2.png" alt="Main" class="img-fluid pb-3">

                        <h2>Your application is under review.</h2>
                        <p class="main-description pt-2">
    Dear agent, your request to connect with Fair Property is under review. Once the application is approved by the admin, we will notify you.
</p>
