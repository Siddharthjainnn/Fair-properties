...
<% String aa1=(String)request.getAttribute("msg1"); %>
        ...
        <div class="jumbotron jumbotron-fluid" style="padding-left:3cm;padding-right: 3cm; ">
            <div class="row justify-content-center text-center mb-4">
                <div class="col-xl-6 col-lg-8 col-sm-10">
                    <h2 class="font-weight-bold">Product Category Update</h2>
                    <p class="text-muted mb-0">Select a category below to Update a Property.</p>
                </div>
            </div>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0">Update commercial properties to the database.</p>
                        ...
                        <a href="commercial_update?category=commercial&agent_id=<%=aa %>&agent_name=<%=aa1 %>" class="btn btn-primary mt-3">Update</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="card border-hover-primary hover-scale">
        <div class="card-body">
            ...
            <p class="text-muted mb-0">Update residential properties to the database.</p>
            <!-- Link to the page where you can add residential properties -->
            <a href="residential_update?category=residential&agent_id=<%=aa %>&agent_name=<%=aa1 %>" class="btn btn-primary mt-3">Update</a>
        </div>
    </div>
</div>
                    ...
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                           <div class="text-primary mb-5">
                            ...
                            <p class="text-muted mb-0">Update agricultural properties to the database.</p>
                            <!-- Link to the page where you can add agricultural properties -->
                            <a href="pnf.jsp" class="btn btn-primary mt-3">Update</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0">Update Investment properties to the database.</p>
                            <!-- Link to the page where you can add agricultural properties -->
