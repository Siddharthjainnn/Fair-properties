...
<title>Product Category View</title>
...
<% String aa1=(String)request.getAttribute("msg1"); %>
        ...
        <div class="jumbotron jumbotron-fluid" style="padding-left:3cm;padding-right: 3cm; ">
            <div class="row justify-content-center text-center mb-4">
                <div class="col-xl-6 col-lg-8 col-sm-10">
                    <h2 class="font-weight-bold">Property Transitions Update</h2>
                    <p class="text-muted mb-0">Select a category below to Add or Update a Property Transitions.</p>
                </div>
            </div>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0">Add or Update a commercial Property Transitions.</p>
                            <!-- Link to the page where you can add commercial properties -->
                            <%-- <a href="commercial_insertion.jsp?category=commercial&agent_id=<%=aa %>&agent_name=<%=aa1 %>" class="btn btn-primary mt-3">Update</a> --%>
                        
                        <a href="commercial_transitions?category=commercial&agent_id=<%=aa %>&agent_name=<%=aa1 %>" class="btn btn-primary mt-3">Add/Update</a>
    ...
    <div class="card border-hover-primary hover-scale">
        <div class="card-body">
            ...
            <p class="text-muted mb-0">Add or Update a Residential Property Transitions..</p>
            <!-- Link to the page where you can add residential properties -->
            <a href="commercial_transitions?category=residential&agent_id=<%=aa %>&agent_name=<%=aa1 %>" class="btn btn-primary mt-3">Add/Update</a>
        </div>
    </div>
</div>
                    ...
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                           <div class="text-primary mb-5">
                            ...
                            <p class="text-muted mb-0">Add or Update a Agricultural Property Transitions.</p>
                            <!-- Link to the page where you can add agricultural properties -->
                            <a href="pnf.jsp" class="btn btn-primary mt-3">Add/Update</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0">Add or Update a Investment Property Transitions.</p>
                            <!-- Link to the page where you can add agricultural properties -->
