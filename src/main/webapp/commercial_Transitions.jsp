    ...
    <div class="card b-1 hover-shadow mb-20">
        ...
        <footer class="card-footer flexbox align-items-center">
            ...
            <a class="btn btn-xs fs-10 btn-bold btn-warning" href="commercial_view?property_id=<%=p.getPropertyId() %>" style="font-size: large;width: 3cm;size: 5cm;" ><label style="font-size: large;">View</label></a>
                <a class="btn btn-xs fs-10 btn-bold btn-info" href="./commercial_Transition_new?property_id=<%=p.getPropertyId() %>&category=<%=p.getCategory() %>&agent_id=<%=p.getAgentId() %>" style="width: 7cm;font-size: xx-large;" ><label style="font-size: large;">Add commercial Transitions</label></a>
