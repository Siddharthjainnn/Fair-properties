                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <select class="select2 form-control select2-hidden-accessible" data-select2-placeholder="Select country" data-select2-id="select2-data-1-gy14" tabindex="-1" aria-hidden="true" name="Property_type" value="<%=pro.getPropertyType()%>">
...
<option value="Dravid Nagar, Ward 71">Dravid Nagar, Ward 71</option>
  ...
  <option value="<%=pro.getAssembly()%>"><%=pro.getAssembly()%></option>
    ...
    <option value="452099">452099</option>
      ...
      <option value="<%=pro.getCity()%>">pro.getCity()</option>
                ...
                <!-- Add more options as needed -->
                                ...
                                <div class="col-lg-4">
                                  <div class="mb-3">
                                    ...
                                    <option data-select2-id="select2-data-3-ibs9" value="<%=pro.getFur()%>"><%=pro.getFur()%></option>
