...
%>
  ...
  <option value="hospitality">Hospitality (Hotels, Motels)</option>
  <option value="healthcare">Healthcare Facilities (Hospitals, Clinics)</option>
  <option value="multifamily">Multifamily Housing (Apartment Buildings, Condos)</option>
</select>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <select class="select2 form-control select2-hidden-accessible" data-select2-placeholder="Select country" data-select2-id="select2-data-1-gy14" tabindex="-1" aria-hidden="true" name="Transaction">
                            <option data-select2-id="select2-data-3-ibs9"></option>
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <input type="month" class="form-control" name="cons_year">
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="mb-3">
                ...
                <!-- Add more options as needed -->
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control"  name="openside">
                        </div>
                      </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="mb-3">
                        <label class="form-label">Area</label>
                        <select name="area" id="area" class="form-control" name="area">
    ...
    <option value="140">140 - ANANDWAN PHASE-2</option>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <select name="assembly" id="assembly" class="form-control" name="assembly">
    <option value=""></option>
    <option value="Depalpur">Depalpur</option>
                ...
                <div class="card-body">
                  <h3 class="h6 mb-4">Other Details</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <label class="form-label">Interior Squart Footage</label>
                            <input type="text" class="form-control" name="Interior">
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <label class="form-label">Source Income (in Ratio)</label>
                            <input type="text" class="form-control" name="income">
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <label class="form-label">How much Expenses(in Rs)</label>
                            <input type="text" class="form-control" name="expences">
                          </div>
                        </div>
    
                        <div class="col-lg-3">
                            <div class="mb-3">
                              <label class="form-label">Property Tax Price </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                              <div class="mb-3">
                                <label class="form-label">Cash-on-Cash Return</label>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                  <label class="form-label">Net Operating Income </label>
                                  <input type="text" class="form-control">
                                </div>
                              </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                      <label class="form-label">Property Insurances</label>
                                      <input type="text" class="form-control">
                                    </div>
                                  </div>
