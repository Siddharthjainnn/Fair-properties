...
<img src="https://teja10.kuikr.com/o1/20191022/ak_84340019-1571720375.jpg" alt />
...
<p><%=mm.getPropertyType()%></p>
<p class="price">Rs.<%=mm.getPrice()%></p>
<p ><%=mm.getLocation()%>  |  <%=mm.getCity()%>  |  <%=mm.getLandmark()%>  |  <%=mm.getPostalCode()%>  |  <%=mm.getCountry()%>  </p>
<a class="btn btn-primary" style="margin-right: 5%;" href="view_new_property?property_id=<%=mm.getPropertyId()%>&customer_id=<%=ak.getCustomerId()%>">view more For This Property</a>

<a class="btn btn-primary" href="customer_intersted?customer_id=<%=ak.getCustomerId()%>&customer_mail_id=<%=ak.getEmail()%>&proprty_id=<%=mm.getPropertyId()%>&property_name=<%=mm.getPropertyName()%>&customer_name=<%ak.getName();%>">Interested ? </a>
</div>
</section>
</div>
