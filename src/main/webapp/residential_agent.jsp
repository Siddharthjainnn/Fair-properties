...
%>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="bedrooms" value="<%=pro.getBedrooms() %>" readonly="readonly">
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <label class="form-label">Bathrooms</label>
                            <input type="text" class="form-control" name="bathrooms" value="<%=pro.getBathrooms() %>" readonly="readonly">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="kitchen" value="<%=pro.getKitchen() %>" readonly="readonly">
                            </div>
                          </div>
                        <div class="col-lg-3">
                            <div class="mb-3">
                              <label class="form-label">Living Room</label>
                              <input type="text" class="form-control" name="living" value="<%=pro.getLiving() %>" readonly="readonly">
                            </div>
                          </div>
                        ...
                        <div class="col-lg-3">
                          <div class="mb-3">
                           ...
                           <input type="text" class="form-control" name="living" value="<%=pro.getParkArea() %>" readonly="readonly">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                              ...
                              <input type="text" class="form-control" name="living" value="<%=pro.getWaterCon() %>" readonly="readonly">
                              </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                          ...
                          <input type="text" class="form-control" name="living" value="<%=pro.getSecurity() %>" readonly="readonly">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="living" value="<%=pro.getGasCon() %>" readonly="readonly">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="dining" value="<%=pro.getDining() %>" readonly="readonly">
                              </div>
                            </div>
                            <div class="col-lg-3">
                              <div class="mb-3">
                                <label class="form-label">Number Of Lift's </label>
                                <input type="text" class="form-control" name="no_of_lift" value="<%=pro.getNoOfLift() %>" readonly="readonly">
                              </div>
                            </div>
            ...
            <input type="text" class="form-control" name="living" value="<%=pro.getOverlooking() %>" readonly="readonly">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" name="living" value="<%=pro.getParking() %>" readonly="readonly">
                                </div>
                              </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="living" value="<%=pro.getFur() %>" readonly="readonly">
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                  <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" name="living" value="<%=pro.getElec() %>" readonly="readonly">
                                  </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                      <label class="form-label">Carpet Area(Sq.feet)</label>
                                      <input type="number" class="form-control"  name="carpet_area" value="<%=pro.getCarpetArea() %>" readonly="readonly">
                                    </div>
                                </div>
