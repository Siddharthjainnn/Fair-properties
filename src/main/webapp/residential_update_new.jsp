...
<form action="commercial_update" method="post" enctype="multipart/form-data">
    <div class="container-fluid">
          ...
          <div class="d-flex justify-content-between align-items-lg-center py-3 flex-column flex-lg-row">
            <h2 class="h5 mb-3 mb-lg-0"><a href="../../pages/admin/customers.html" class="text-muted"><i class="bi bi-arrow-left-square me-2"></i></a> Residential Property</h2>
            <div class="hstack gap-3">
              
              <button type="submit" class="btn btn-primary btn-sm btn-icon-text" style="width: 4cm;height: 1cm;"><i class="bi bi-save"></i> <span class="text">Update</span></button>
            </div>
          </div>
...
%>
 --%>
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="property_name" value="<%=pro.getPropertyName() %>" >
                     ...
                     <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <select class="select2 form-control select2-hidden-accessible" data-select2-placeholder="Select country" data-select2-id="select2-data-1-gy14" tabindex="-1" aria-hidden="true" name="Property_type">
                            <option value="<%=pro.getPropertyType()%>"><%=pro.getPropertyType()%></option>
                          ...
                          <input type="hidden" value="residential" name="category" >
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control"  name="price" required="required" value="<%=pro.getPrice()%>">
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="length" required="required" value="<%=pro.getLength()%>">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control"  name="width" required="required" value="<%=pro.getWidth()%>">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3">
                        <div class="mb-3">
                          ...
                          <select class="select2 form-control select2-hidden-accessible" data-select2-placeholder="Select country" data-select2-id="select2-data-1-gy14" tabindex="-1" aria-hidden="true" name="Ownership" >
                            <option value="<%=pro.getOwnership()%>"><%=pro.getOwnership()%></option>
                    ...
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <select class="select2 form-control select2-hidden-accessible" data-select2-placeholder="Select country" data-select2-id="select2-data-1-gy14" tabindex="-1" aria-hidden="true" name="Transaction" required="required">
                            <option value="<%=pro.getTransaction()%>"><%=pro.getTransaction()%></option>
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <input type="month" class="form-control" id="cons_year" name="cons_year" value="<%=pro.getConsYear()%>">
                    ...
                    <div class="col-lg-3">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="floors" value="<%=pro.getFloors()%>">
                      </div>
                    </div>
                ...
                <option value="<%=pro.getDirection()%>"><%=pro.getDirection()%></option>
                ...
                <!-- Add more options as needed -->
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="openside" name="openside" required="required" value="<%=pro.getOpenside()%>">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="adress" required="required" value="<%=pro.getAddress()%>">
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="mb-3">
                        ...
                        <option value="<%=pro.getArea()%>"><%=pro.getArea()%></option>
    ...
    <option value="HATOD">HATOD</option>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="landmark" value="<%=pro.getLandmark()%>">
                        </div>
                      </div>
...
<option value="<%=pro.getWard()%>" ><%=pro.getWard()%></option>
...
<option value="Dravid Nagar, Ward 71">Dravid Nagar, Ward 71</option>
  ...
  <option value="<%=pro.getAssembly()%>"><%=pro.getAssembly()%></option>
    <option value="Depalpur">Depalpur</option>
    ...
    <option value="<%=pro.getZipcode()%>"><%=pro.getZipcode()%></option>
    ...
    <option value="452099">452099</option>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" value="Madhya Pradesh" readonly="readonly" name="state" value="<%=pro.getState()%>">
                    ...
                    <div class="col-lg-4">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="India" readonly="readonly" name="country" value="<%=pro.getCountry()%>">
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mb-4">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="bedrooms" value="<%=pro.getBedrooms()%>">
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="mb-3">
                            <label class="form-label">Bathrooms</label>
                            <input type="text" class="form-control" name="bathrooms" value="<%=pro.getBathrooms()%>">
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="kitchen" value="<%=pro.getKitchen()%>">
                            </div>
                          </div>
                        <div class="col-lg-3">
                            <div class="mb-3">
                              <label class="form-label">Living room</label>
                              <input type="text" class="form-control" name="living" value="<%=pro.getLiving()%>">
                            </div>
                          </div>
               ...
               <option value="<%=pro.getParkArea()%>"><%=pro.getParkArea()%></option>
              ...
              <option value="<%=pro.getWaterCon()%>"><%=pro.getWaterCon()%></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                ...
                <option value="<%=pro.getSecurity()%>"><%=pro.getSecurity()%></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                ...
                <!-- Add more options as needed -->
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                              ...
                              <option value="<%=pro.getGasCon()%>"><%=pro.getGasCon()%></option>
                              <option value="Yes">Yes</option>
                <option value="No">No</option>
                ...
                <!-- Add more options as needed -->
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                              <div class="mb-3">
                                <label class="form-label">Dining area(sq.feet)</label>
                                <input type="text" class="form-control"  name="dining" value="<%=pro.getDining()%>">
                              </div>
                            </div>
                            <div class="col-lg-3">
                              <div class="mb-3">
                                <label class="form-label">Number Of Lift's </label>
                                <input type="text" class="form-control" name="no_of_lift" value="<%=pro.getNoOfLift()%>">
                              </div>
                            </div>
           ...
           <option value="<%=pro.getOverlooking()%>"><%=pro.getOverlooking()%></option>
                ...
                <!-- Add more options as needed -->
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                  <label class="form-label">Garage Or Parking Space</label>
               ...
               <option value="<%=pro.getParkArea()%>"><%=pro.getParkArea()%></option>
                ...
                <!-- Add more options as needed -->
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                  <div class="mb-3">
                                    <label class="form-label">Yard Or Garden</label>
                                     <select class="form-select" name="garden">
                <option value="<%=pro.getGarden()%>"><%=pro.getGarden()%></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                ...
                <!-- Add more options as needed -->
                                ...
                                <div class="col-lg-3">
                                  <div class="mb-3">
                                    ...
                                    <option value="<%=pro.getFur()%>"><%=pro.getFur()%></option>
              ...
              <option value="<%=pro.getElec()%>"><%=pro.getElec()%></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                ...
                <!-- Add more options as needed -->
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                      <label class="form-label">Carpet Area(Sq.feet)</label>
                                      <input type="number" class="form-control"  name="carpet_area" value="<%=pro.getCarpetArea()%>">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="owner_name" value="<%=pro.getOwnerName() %>" required="required">
                            ...
                            <div class="col-lg-3">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="owner_number" required="required" value="<%=pro.getOwnerNumber()%>">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="owner_email" required="required" value="<%=pro.getOwnerEmail()%>">
                              ...
                              <div class="col-lg-3">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" value="<%=pro.getAgentName() %>" readonly="readonly" name="agent_name">
                                  <input type="hidden" class="form-control" value="<%=pro.getAgentId() %>" name="agent_id">
                                </div>
                              </div> 
                            </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <input class="form-control" type="text"  name="status" readonly="readonly" value=<%=pro.getStatus() %>>
                </div>
              </div>
              <!-- Avatar -->
              <div class="card mb-4">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <input class="form-control" rows="3" name="notes" value="<%=pro.getNotes()%>"></input>
                </div>
              </div>
             <div class="card mb-4">
                <div class="card-body">
                ...
                <option value="<%=pro.getRent()%>"><%=pro.getRent()%></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
                      </div>
                    </li>
