    ...
    <div class="card b-1 hover-shadow mb-20">
        ...
        <footer class="card-footer flexbox align-items-center">
            ...
            <a class="btn btn-xs fs-10 btn-bold btn-warning" href="commercial_view?property_id=<%=p.getPropertyId() %>" style="font-size: large;width: 3cm;size: 5cm;" >View</a>
                ...
                <a class="btn btn-xs fs-10 btn-bold btn-danger" href="./commercial_delete?property_id=<%=p.getPropertyId() %>&category=<%=p.getCategory() %>&agent_id=<%=p.getAgentId() %>"  onclick=" return alert('are you sure you whant to delete')" style="font-size: large;size: 5cm;">Delete</a>
            </div>
        </footer>
    </div>
